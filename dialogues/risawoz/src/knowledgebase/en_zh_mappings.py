...
class RisawozMapping(object):
    def __init__(self):
        ...
        self.zh2en_SLOT_MAP = {
            ...
            'DSA': 'DSA',
            '3.0T MRI': '3.0T MRI',
            '重点科室': 'key departments',
            '电话': 'phone',
            '公交线路': 'bus routes',
            '地铁可达': 'metro station',
            'CT': 'CT',
            '等级': 'level',
            '性质': 'public or private',
            '类别': 'general or specialized',
            '地址': 'address',
            '温度': 'tamperature',
            '目的地': 'destination',
            '日期': 'date',
            ...
            '菜系': 'cuisine',
            '评分': 'score',
            '最适合人群': 'the most suitable people',
            '房费': 'room charge',
            '景点类型': 'type',
            '房型': 'room type',
            '推荐菜': 'dishes',
            ...
            '开放时间': 'opening hours',
            '价位': 'pricerange',
            '是否地铁直达': 'metro station',
            '特点': 'features',
            '座椅通风': 'ventilated seats',
            '油耗水平': 'fuel consumption',
            '级别': 'size',
            '能源类型': 'hybrid',
            '价格': 'price',
            '驱动方式': '4WD',
            ...
            '车次信息': 'train number',
            '出发地': 'departure',
            '准点率': 'punctuality rate',
            '航班信息': 'flight information',
            '坐席': 'seat type',
            '制片国家/地区': 'production country or area',
            '豆瓣评分': 'Douban score',
            '片名': 'title',
            '主演名单': 'name list',
            '具体上映时间': 'release date',
