...
class RisawozMapping(object):
    def __init__(self, src='zh', tgt='en'):
        ...
        self.DOMAIN_SLOT_MAPS = {
            ...
            "en": {
                'hospital': [
                    'area', 'name', 'service_time', 'registration_time', 'DSA',
                    '3.0T_MRI', 'key_departments', 'phone', 'bus_routes',
                    'metro_station', 'CT', 'level', 'public_or_private',
                    'general_or_specialized', 'address'],
                'weather': [
                    'tamperature', 'destination', 'date', 'city', 'wind',
                    'weather_condition', 'UV_intensity'],
                'attraction': [
                    'ticket_price', 'phone_number', 'cuisine', 'name', 'score',
                    'the_most_suitable_people', 'room_charge', 'type', 'room_type',
                    'dishes', 'consumption', 'opening_hours', 'pricerange',
                    'metro_station', 'area', 'address', 'features'],
                'car': [
                    'ventilated_seats', 'fuel_consumption', 'size', 'hybrid', 'name',
                    'price', '4WD', 'pricerange', 'classification', 'number_of_seats',
                    'heated_seats', 'parking_assist_system', 'cruise_control_system',
                    'power_level', 'series', 'brand'],
                'train': [
                    'departure_time', 'ticket_price', 'destination', 'classification',
                    'class_cabin', 'date', 'duration', 'arrival_time', 'train_number',
                    'departure', 'punctuality_rate', 'flight_information', 'seat_type'],
                'movie': [
                    'production_country_or_area', 'Douban_score', 'title', 'name_list',
                    'release_date', 'director', 'film_length', 'type', 'decade',
                    'star'],
                'pc': [
                    'pricerange', 'memory_capacity', 'product_name', 'GPU_model',
                    'weight', 'price', 'brand', 'operating_system', 'CPU_model',
                    'series', 'screen_size', 'game_performance', 'usage',
                    'computer_type', 'standby_time', 'colour', 'hard_disk_capacity',
                    'CPU', 'GPU_category'],
                'tv': [
                    'production_country_or_area', 'Douban_score', 'title', 'name_list',
                    'premiere_time', 'director', 'film_length', 'episodes',
                    'episode_length', 'type', 'decade', 'star'],
                'class': [
                    'start_date', 'teacher', 'type', 'campus', 'price', 'level', 'time',
                    'hours', 'subject', 'class_number', 'end_date', 'grade', 'end_time',
                    'classroom', 'day', 'times', 'start_time', 'area'],
                'hotel': [
                    'phone_number', 'star', 'name', 'room_charge', 'address',
                    'metro_station', 'room_type', 'parking', 'dishes', 'hotel_type',
                    'pricerange', 'metro_station', 'area', 'score'],
                'flight': [
                    'departure_time', 'ticket_price', 'tamperature', 'destination',
                    'departure_time', 'class_cabin', 'date', 'city', 'arrival_time',
                    'departure', 'punctuality_rate', 'flight_information',
                    'weather_condition'],
                'restaurant': ['business_hours', 'phone_number', 'cuisine', 'name',
                               'score', 'room_charge', 'per_capita_consumption',
                               'dishes', 'opening_hours', 'pricerange',
                               'metro_station', 'area', 'address'],
                'general': []
            }
        }
        ...
        self.zh2en_DOMAIN_MAP = self.zh2en_DOMAIN_MAPS[f"{src}2{tgt}"]
        ...
        self.zh2en_SLOT_MAP = self.zh2en_SLOT_MAPS[f"{src}2{tgt}"]
